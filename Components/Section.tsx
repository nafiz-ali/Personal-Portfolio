...
const Section: React.FC<SectionProps> = ({ id, title, children, className = '' }) => {
  ...
  return (
    <section 
        ref={ref} 
        id={id} 
        className={`container mx-auto px-6 py-20 md:py-28 min-h-[60vh] transition-all duration-1000 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} ${className}`}
    >
