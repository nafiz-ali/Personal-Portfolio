    ...
    <section id={SECTION_IDS.home} className="min-h-screen flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
        ...
        <div className="z-10">
            ...
            <p className="max-w-2xl mx-auto mt-8 text-lg text-gray-300">
                Crafting immersive and beautiful web experiences from concept to deployment.
            </p>
            <div className="mt-12">
                <a 
                  href={`#${SECTION_IDS.projects}`} 
                  onClick={handleScrollDown}
                  className="bg-transparent border-2 border-cyan-500 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 button-glow hover:bg-cyan-500/20">
                    View My Work
                </a>
            </div>
        </div>
